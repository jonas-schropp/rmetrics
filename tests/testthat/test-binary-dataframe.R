...
test_that("calc_f05 works with valid input", {
  expect_equal(
    calc_f05(data, "prediction", "reference"),
    0.521, # pycm
    tolerance = 0.001
  )
})
test_that("calc_f1 works with valid input", {
  expect_equal(
    calc_f1(data, "prediction", "reference"),
    0.556, # pycm
    tolerance = 0.001
  )
})
test_that("calc_f2 works with valid input", {
  expect_equal(
    calc_f2(data, "prediction", "reference"),
    0.595, # pycm
    tolerance = 0.001
  )
})
...
test_that("calc_agm works with valid input", {
  expect_equal(
    calc_agm(data, "prediction", "reference"), # adjusted geometric mean,
    0.596, # pycm
    tolerance = 0.001
  )
})
